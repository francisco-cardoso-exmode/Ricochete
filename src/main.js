...
async function start(){
 await initPhysics();sim=new Simulation();graphics=new Graphics($('#game'),sim);graphics.overview=overview;$('#stage').classList.add('overview');$('#loading').remove();updateControls();updateHUD();
